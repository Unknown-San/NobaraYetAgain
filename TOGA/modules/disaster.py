...
SUDO_HANDLER = CommandHandler(("addprecepts"), addsudo)
SUPPORT_HANDLER = CommandHandler(("addvillain"), addsupport)
TIGER_HANDLER = CommandHandler(("addnomu"), addtiger)
WHITELIST_HANDLER = CommandHandler(("adddeku"), addwhitelist)
UNSUDO_HANDLER = CommandHandler(("removeprecepts"), removesudo)
UNSUPPORT_HANDLER = CommandHandler(("removevillain"),
                                   removesupport)
UNTIGER_HANDLER = CommandHandler(("removenomu"), removetiger)
UNWHITELIST_HANDLER = CommandHandler(("removedeku"),
                                     removewhitelist)

WHITELISTLIST_HANDLER = CommandHandler(["dekus"],
                                       whitelistlist)
