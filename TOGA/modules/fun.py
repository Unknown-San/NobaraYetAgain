...
def slap(update: Update, context: CallbackContext):
    ...
    if update.effective_user.id == 5163444566:
        temp = "Are you stupid {user2}, KAC is MY LOVE"
...
__command_list__ = [
    ...
    "sex", "pat", "sanitize", "shout", "cosplay", "weebify", "flirt", "gbam"
]
__handlers__ = [
    ...
    SEX_HANDLER, SHOUT_HANDLER, WEEBIFY_HANDLER, COSPLAY_HANDLER, GBAM_HANDLER
]
